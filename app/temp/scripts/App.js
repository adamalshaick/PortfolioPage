...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Links = function () {
	  function Links() {
	    ...
	    this.navbarHr = (0, _jquery2.default)(".navbar__hr");
	    this.headerTriggerElement = (0, _jquery2.default)("#start");

	    this.pageSections = (0, _jquery2.default)(".page-section");
	    this.navbarLinks = (0, _jquery2.default)(".page-section__next a");
	      ...
	      this.pageSections.each(function () {
	        ...
	        new Waypoint({
	          ...
	          handler: function handler(direction) {
	            if (direction == "down") {
	              var matchingNavbarLink = currentPageSection.getAttribute("data-matching-link");
	              that.navbarLinks.removeClass("is-current-link");
	              (0, _jquery2.default)(matchingNavbarLink).addClass("is-current-link");
	            }
	          },
	          offset: "18%"
	        });
